  ...
  return <div id="riskDAO" className="section-container withOverflowingBackground-4 section-4">
    <section className="grid">
      <div className="section-main">
        ...
        <div className="section-txt">RiskDAO, a sub-DAO of B.Protocol, is a service DAO focused on providing a new, open-source risk assessment framework, associated audits, and dashboards to stress test, monitor, and manage risk in DeFi lending protocols as well as stablecoins, L1 and L2 networks.</div>
